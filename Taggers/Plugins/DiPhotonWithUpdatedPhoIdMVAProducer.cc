...
#include "PhotonCNN/MicroAOD/interface/PhotonIdUtils.h"
#include "PhotonCNN/DataFormats/interface/DiPhotonCandidate.h"
...
#include "PhotonCNN/Taggers/src/IsolationCorrection.C"
